...
T_i_c_np = np.eye(4)
T_i_c_np[:3,3] = np.array([0.013991958832708196,-0.040766470166917895,0.01589418686420154])
T_i_c_np[:3,:3] = R.from_quat([0.0017841953862121206,-0.0014240956361964555,-0.7055056377782172,0.7087006304932949]).as_matrix()
