...
class RSError:
    def __init__(self, knot_start_ids, line_delay, inv_dts, T_i_c, cam_matrix):
        ...
        self.spline_helper = SplineHelper(4, cam_matrix.tensor.device)
    ...
    def __call__(self, optim_vars, aux_vars):
        ...
        inv_depths = aux_vars[2].tensor
        ref_obs = aux_vars[3].tensor
        obs_obs = aux_vars[4].tensor
